...
S4_package_example is a R script for demo purpose. The zip file has all the preprocessed data, whcih are also imported in the R package `S4`. The Rscripts folder contains all the code to reproduce the result in the following paper:
